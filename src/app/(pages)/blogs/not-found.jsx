    ...
    <div className='flex justify-center items-center w-full'>
      <div className={`h-screen  flex justify-center items-center w-full`}>
        <div className='relative text-center md:text-start w-full md:w-auto'>
            ...
            <p className='w-full -mt-10 md:mt-0 xl:w-[160%] md:absolute md:-left-5 md:top-2/4 text-secondary font-bold text-xl md:text-3xl'>Oops! That blogs can't be found</p>
